...
const Template = (args) => {
    return html`
        <div class="widget widget-big vertical-column widget-show" id="RevenuebyPayment">
            ...
            <div class="widget-chart">
                <table id="sales-per-product"
                        class="charts-css column show-labels show-5-secondary-axes multiple stacked">
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <span>Jan</span>
                            ...
                            <tr>
                                <th scope="row">
                                    <span>May</span>
                                <td style="--size:0.15;"></td>
                                <td style="--size:0.19;"></td>
                                </th>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <span>Jun</span>
                                <td style="--size:0.14;"></td>
                                <td style="--size:0.12;"></td>
                                </th>
                            </tr>
                        </tbody>
                    </table>
